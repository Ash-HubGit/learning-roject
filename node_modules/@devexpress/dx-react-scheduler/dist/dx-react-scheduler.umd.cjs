...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var AppointmentsBase = /*#__PURE__*/ (function (_super) {
        ...
        AppointmentsBase.prototype.render = function () {
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "Appointments", dependencies: pluginDependencies$2 },
                React.createElement(dxReactCore.Template, { name: "timeTableAppointmentLayer" },
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                ...
                React.createElement(dxReactCore.Template, { name: "allDayAppointmentLayer" },
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                ...
                React.createElement(dxReactCore.Template, { name: "appointmentContent" }, function (_a) {
                    ...
                    return (React.createElement(Appointment, __assign({ forwardedRef: forwardedRef, data: data, resources: resources }, dxCore.createClickHandlers(onClick, onDoubleClick), restParams),
    ...
    var isMonthView = function (currentView) { return currentView.type === dxSchedulerCore.VIEW_TYPES.MONTH; };
    var isVerticalGrouping = function (currentView, groupOrientation) { return (groupOrientation === null || groupOrientation === void 0 ? void 0 : groupOrientation(currentView.name)) === dxSchedulerCore.VERTICAL_GROUP_ORIENTATION; };
    ...
    var AllDayAppointmentLayerPlaceholder = function () {
        return React.createElement(dxReactCore.TemplatePlaceholder, { name: "allDayAppointmentLayer" });
    };
    ...
    var AllDayTitlePlaceholder = function (params) { return React.createElement(dxReactCore.TemplatePlaceholder, { name: "allDayTitle", params: params }); };
    var AllDayPanelBase = /*#__PURE__*/ (function (_super) {
        ...
        function AllDayPanelBase() {
            ...
            _this.allDayCellsDataComputed = dxCore.memoize(function (_a) {
                var viewCellsData = _a.viewCellsData;
                return dxSchedulerCore.allDayCells(viewCellsData);
            });
            _this.updateCellElementsMeta = dxCore.memoize(function (cellElementsMeta) {
                _this.setState({ elementsMeta: cellElementsMeta });
            });
            _this.allDayAppointmentsComputed = dxCore.memoize(function (_a) {
                var appointments = _a.appointments, startViewDate = _a.startViewDate, endViewDate = _a.endViewDate, excludedDays = _a.excludedDays;
                ...
                return dxSchedulerCore.calculateAllDayDateIntervals(appointments, allDayLeftBound, allDayRightBound, excludedDays);
            });
            _this.allDayPanelExistsComputed = dxCore.memoize(function (_a) {
                var currentView = _a.currentView;
        ...
        AllDayPanelBase.prototype.render = function () {
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "AllDayPanel", dependencies: pluginDependencies$3 },
                ...
                React.createElement(dxReactCore.Getter, { name: "allDayCellsData", computed: this.allDayCellsDataComputed }),
                React.createElement(dxReactCore.Getter, { name: "allDayPanelExists", computed: this.allDayPanelExistsComputed }),
                React.createElement(dxReactCore.Getter, { name: "allDayAppointments", computed: this.allDayAppointmentsComputed }),
                React.createElement(dxReactCore.Template, { name: "timeTable" }, function (params) { return (React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                    ...
                    return (React.createElement(React.Fragment, null,
                        React.createElement(dxReactCore.TemplatePlaceholder, { params: __assign(__assign({}, params), { allDayCellComponent: CellPlaceholder$1, allDayRowComponent: rowComponent, allDayCellsData: allDayCellsData }) }),
                        React.createElement(AppointmentLayer, null,
                            React.createElement(AllDayAppointmentLayerPlaceholder, null))));
                })); }),
                React.createElement(dxReactCore.Template, { name: "dayScaleEmptyCell" },
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                        ...
                        return (React.createElement(AllDayTitlePlaceholder, null));
                    })),
                React.createElement(dxReactCore.Template, { name: "timeScale" }, function (params) { return (React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                    var currentView = _a.currentView, groupOrientation = _a.groupOrientation;
                    if (isMonthView(currentView)
                    ...
                    return (React.createElement(dxReactCore.TemplatePlaceholder, { params: __assign(__assign({}, params), { allDayTitleComponent: AllDayTitlePlaceholder, showAllDayTitle: true }) }));
                })); }),
                React.createElement(dxReactCore.Template, { name: "dayScale" },
                    React.createElement(dxReactCore.TemplatePlaceholder, null),
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                ...
                React.createElement(dxReactCore.Template, { name: "allDayPanel" },
                    ...
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                        ...
                        if (currentView.type === dxSchedulerCore.VIEW_TYPES.MONTH)
                            return null;
                        return (React.createElement(React.Fragment, null,
                            React.createElement(Layout, { cellComponent: CellPlaceholder$1, rowComponent: rowComponent, cellsData: allDayCellsData[0], setCellElementsMeta: _this.updateCellElementsMeta, formatDate: formatDate, key: layoutKey }),
                            React.createElement(AppointmentLayer, null,
                                React.createElement(AllDayAppointmentLayerPlaceholder, null))));
                    })),
                React.createElement(dxReactCore.Template, { name: "allDayTitle" }, function (params) { return React.createElement(TitleCell, __assign({ getMessage: getMessage }, params)); }),
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "AppointmentTooltip", dependencies: pluginDependencies$4 },
                ...
                React.createElement(dxReactCore.Template, { name: "timeTable" },
                    ...
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a, _b) {
                        ...
                        return (React.createElement(dxReactCore.TemplatePlaceholder, { name: "tooltip", params: {
                                ...
                                appointmentMeta: appointmentMeta,
                                appointmentResources: appointmentMeta ? dxSchedulerCore.getAppointmentResources(appointmentMeta.data, resources, plainResources) : [],
                                visible: visible,
    ...
    var addDoubleClickToCell = function (title, startDate, endDate, groupingInfo, resources, allDay, openFormHandler, addAppointment, params) {
        ...
        var validResourceFields = resources
            ? dxSchedulerCore.checkMultipleResourceFields(resourceFields, resources)
            : resourceFields;
        var newAppointmentData = __assign({ title: title, startDate: startDate, endDate: endDate, allDay: allDay }, validResourceFields);
    ...
    var AppointmentFormBase = /*#__PURE__*/ (function (_super) {
        ...
        AppointmentFormBase.prototype.render = function () {
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "AppointmentForm", dependencies: pluginDependencies$5 },
                ...
                React.createElement(dxReactCore.Template, { name: "cell" }, function (params) { return (React.createElement(dxReactCore.TemplateConnector, null, function (_a, _b) {
                    var resources = _a.resources;
                    var addAppointment = _b.addAppointment;
                    return addDoubleClickToCell(undefined, params.startDate, params.endDate, params.groupingInfo, resources, dxSchedulerCore.isAllDayCell(params.startDate, params.endDate), _this.openFormHandler, addAppointment, params);
                })); }),
                React.createElement(dxReactCore.Template, { name: "allDayPanelCell" }, function (params) { return (React.createElement(dxReactCore.TemplateConnector, null, function (_a, _b) {
                    var resources = _a.resources;
                    var addAppointment = _b.addAppointment;
    ...
    var DragDropProviderBase = /*#__PURE__*/ (function (_super) {
        ...
        DragDropProviderBase.prototype.calculateBoundaries = function (_a, _b, _c, scrollSpeed) {
            ...
            if (clientOffset) {
                dxSchedulerCore.autoScroll(clientOffset, scrollingStrategy, scrollSpeed);
            }
            ...
            if (allDayIndex === -1 && timeTableIndex === -1)
                return;
            var targetData = dxSchedulerCore.cellData(timeTableIndex, allDayIndex, viewCellsData, allDayCellsData);
            ...
            var appointmentGroups = dxSchedulerCore.calculateAppointmentGroups(targetData.groupingInfo, resources, payload);
            ...
            if (!dxSchedulerCore.appointmentDragged(this.appointmentStartTime, startTime, this.appointmentEndTime, endTime, this.appointmentGroupingInfo, appointmentGroupingInfo)) {
                return;
            }
            ...
            var _f = dxSchedulerCore.calculateDraftAppointments(allDayIndex, draftAppointments, startViewDate, endViewDate, excludedDays, viewCellsData, allDayCellsElementsMeta, targetType, cellDurationMinutes, tableCellElementsMeta, grouping, resources, groups, groupOrientation, groupByDate === null || groupByDate === void 0 ? void 0 : groupByDate(currentView === null || currentView === void 0 ? void 0 : currentView.name)), allDayDraftAppointments = _f.allDayDraftAppointments, timeTableDraftAppointments = _f.timeTableDraftAppointments;
        ...
        DragDropProviderBase.prototype.render = function () {
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "DragDropProvider", dependencies: pluginDependencies$6 },
                ...
                React.createElement(dxReactCore.Template, { name: "appointmentContent", predicate: function (_a) {
                    ...
                    return (React.createElement(dxReactCore.DragSource, { payload: __assign(__assign({}, params.data), { type: params.type }) }, payload && params.data.id === payload.id ? (React.createElement(SourceAppointment, __assign({}, params))) : (React.createElement(dxReactCore.PlaceholderWithRef, { params: __assign(__assign({}, params), { draggable: true }) }))));
                }),
                React.createElement(dxReactCore.Template, { name: "appointmentTop", predicate: function (params) { return !params.slice && allowResize(params.data); }, key: appointmentTopTemplateKey }, function (_a) {
                ...
                React.createElement(dxReactCore.Template, { name: "appointmentBottom", predicate: function (params) { return !params.slice && allowResize(params.data); }, key: appointmentBottomTemplateKey }, function (_a) {
                    var data = _a.data, type = _a.type;
                ...
                React.createElement(dxReactCore.Template, { name: "allDayPanel" },
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                        ...
                        return (React.createElement(React.Fragment, null,
                            React.createElement(dxReactCore.TemplatePlaceholder, null),
                            (groupOrientation === null || groupOrientation === void 0 ? void 0 : groupOrientation(currentView.name)) !== dxSchedulerCore.VERTICAL_GROUP_ORIENTATION
                ...
                React.createElement(dxReactCore.Template, { name: "draftAppointment" }, function (_a) {
                    ...
                    return (React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                        ...
                        return (React.createElement(DraftAppointment, __assign({ data: data, resources: dxSchedulerCore.getAppointmentResources(dataItem, resources, plainResources), durationType: durationType, style: dxSchedulerCore.getAppointmentStyle(geometry), type: type, fromPrev: fromPrev, toNext: toNext, formatDate: formatDate }, restParams)));
                    }));
                })));
        };
        ...
        DragDropProviderBase.defaultProps = {
            allowDrag: function () { return true; },
            allowResize: function () { return true; },
            scrollSpeed: dxSchedulerCore.SCROLL_SPEED_PX,
        };
    ...
    var addResourcesToTimeTableAppointments = function (_a) {
        ...
        return timeTableAppointments
            && dxSchedulerCore.addResourcesToAppointments(timeTableAppointments[0], resources, plainResources);
    };
    var addResourcesToAllDayAppointments = function (_a) {
        ...
        return allDayAppointments
            && dxSchedulerCore.addResourcesToAppointments(allDayAppointments[0], resources, plainResources);
    };
    var ResourcesBase = React.memo(function (_a) {
        ...
        return (React.createElement(dxReactCore.Plugin, { name: "Resources", dependencies: pluginDependencies$a },
            ...
            React.createElement(dxReactCore.Getter, { name: "timeTableAppointments", computed: addResourcesToTimeTableAppointments }),
            React.createElement(dxReactCore.Getter, { name: "allDayAppointments", computed: addResourcesToAllDayAppointments })));
    });
    ...
    var GroupingStateBase = /*#__PURE__*/ (function (_super) {
        ...
        function GroupingStateBase(props) {
            ...
            _this.toggleGroupExpanded = _this.stateHelper.applyReducer
                .bind(_this.stateHelper, dxSchedulerCore.toggleExpandedGroups);
            return _this;
        }
        ...
        GroupingStateBase.prototype.render = function () {
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "GroupingState" },
                React.createElement(dxReactCore.Getter, { name: "grouping", value: grouping }),
                React.createElement(dxReactCore.Getter, { name: "groupByDate", value: groupByDate }),
                React.createElement(dxReactCore.Getter, { name: "groupOrientation", value: groupOrientation }),
        ...
        GroupingStateBase.defaultProps = {
            ...
            groupOrientation: function () { return dxSchedulerCore.HORIZONTAL_GROUP_ORIENTATION; },
        };
    ...
    var GroupingPanelBase = /*#__PURE__*/ (function (_super) {
        ...
        GroupingPanelBase.prototype.render = function () {
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "GroupingPanel", dependencies: pluginDependencies$c },
                React.createElement(dxReactCore.Template, { name: "groupingPanel" },
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                        ...
                        return groupOrientation === dxSchedulerCore.HORIZONTAL_GROUP_ORIENTATION ? (React.createElement(HorizontalLayout, { rowComponent: rowComponent, cellComponent: cellComponent, groups: groups, colSpan: viewCellsData[0].length, cellStyle: {
                                left: scrollingStrategy.fixedLeftWidth ? scrollingStrategy.fixedLeftWidth
                                    : (currentView === null || currentView === void 0 ? void 0 : currentView.type) === dxSchedulerCore.VIEW_TYPES.MONTH
                                        ? dxSchedulerCore.HORIZONTAL_VIEW_LEFT_OFFSET
                                        : dxSchedulerCore.VERTICAL_VIEW_LEFT_OFFSET,
                            }, showHeaderForEveryDate: groupByDate === null || groupByDate === void 0 ? void 0 : groupByDate(currentView && currentView.name) })) : (React.createElement(VerticalLayout, { rowComponent: rowComponent, cellComponent: cellComponent, groups: groups, rowSpan: viewCellsData.length, viewType: currentView === null || currentView === void 0 ? void 0 : currentView.type, cellTextTopOffset: scrollingStrategy === null || scrollingStrategy === void 0 ? void 0 : scrollingStrategy.fixedTopHeight, alignWithAllDayRow: allDayPanelExists }));
                    }))));
        };
    ...
    var CurrentTimeIndicatorBase = function (_a) {
        ...
        return (React.createElement(dxReactCore.Plugin, { name: "CurrentTimeIndicator", dependencies: pluginDependencies$d },
    ...
    var getViewCellsDataComputed = function (_a) {
        ...
        return dxSchedulerCore.expandViewCellsDataWithGroups(viewCellsData, groups, resourcesToGroupBy, groupByDate(currentView.name), groupOrientation(currentView.name));
    };
    var getAllDayCellsDataComputed = function (_a) {
        ...
        return allDayCellsData && dxSchedulerCore.expandViewCellsDataWithGroups(allDayCellsData, groups, resourcesToGroupBy, groupByDate(currentView.name), groupOrientation(currentView.name));
    };
    var getGroupsComputed = function (_a) {
        var resourcesToGroupBy = _a.resourcesToGroupBy;
        return dxSchedulerCore.getGroupsFromResources(resourcesToGroupBy);
    };
    var getResourcesToGroupByComputed = function (_a) {
        var resources = _a.resources, grouping = _a.grouping;
        return dxSchedulerCore.sortFilteredResources(dxSchedulerCore.filterResourcesByGrouping(resources, grouping), grouping);
    };
    var getGroupingComputed = function (_a) {
        var grouping = _a.grouping, resources = _a.resources;
        return dxSchedulerCore.updateGroupingWithMainResource(grouping, resources);
    };
    var getTimeTableAppointmentsComputed = function (_a) {
        ...
        return timeTableAppointments
            && dxSchedulerCore.expandGroups(timeTableAppointments, grouping, resourcesToGroupBy, groups, excludedDays, groupByDate(currentView === null || currentView === void 0 ? void 0 : currentView.name) && (currentView === null || currentView === void 0 ? void 0 : currentView.type) === dxSchedulerCore.VIEW_TYPES.MONTH);
    };
    var getAllDayAppointmentsComputed = function (_a) {
        ...
        return allDayAppointments &&
            dxSchedulerCore.expandGroups(allDayAppointments, grouping, resourcesToGroupBy, groups, excludedDays, groupByDate(currentView === null || currentView === void 0 ? void 0 : currentView.name));
    };
    var getGroupByDateComputed = function (_a) {
        ...
        return groupOrientation(currentView === null || currentView === void 0 ? void 0 : currentView.name) === dxSchedulerCore.VERTICAL_GROUP_ORIENTATION
    ...
    var getTimeTableElementsMetaComputed = function (_a) {
        ...
        return dxSchedulerCore.updateTimeTableCellElementsMeta(timeTableElementsMeta, groupOrientation, groups, allDayPanelExists, viewCellsData, currentView);
    };
    var getAllDayElementsMetaComputed = function (_a) {
        ...
        return dxSchedulerCore.updateAllDayCellElementsMeta(allDayElementsMeta, timeTableElementsMeta, groupOrientation, groups, allDayPanelExists, viewCellsData, currentView);
    };
    var getTimeCellsDataComputed = function (_a) {
        ...
        return timeCellsData
            && dxSchedulerCore.updateTimeCellsData(viewCellsData, timeCellsData, groups, resourcesToGroupBy, groupOrientation(currentView.name));
    };
    var IntegratedGroupingBase = React.memo(function () { return (React.createElement(dxReactCore.Plugin, { name: "IntegratedGrouping", dependencies: pluginDependencies$e },
        React.createElement(dxReactCore.Getter, { name: "groupByDate", computed: getGroupByDateComputed }),
        React.createElement(dxReactCore.Getter, { name: "grouping", computed: getGroupingComputed }),
        React.createElement(dxReactCore.Getter, { name: "resourcesToGroupBy", computed: getResourcesToGroupByComputed }),
        React.createElement(dxReactCore.Getter, { name: "groups", computed: getGroupsComputed }),
        React.createElement(dxReactCore.Getter, { name: "viewCellsData", computed: getViewCellsDataComputed }),
        React.createElement(dxReactCore.Getter, { name: "allDayCellsData", computed: getAllDayCellsDataComputed }),
        React.createElement(dxReactCore.Getter, { name: "timeCellsData", computed: getTimeCellsDataComputed }),
        React.createElement(dxReactCore.Getter, { name: "timeTableAppointments", computed: getTimeTableAppointmentsComputed }),
        React.createElement(dxReactCore.Getter, { name: "allDayAppointments", computed: getAllDayAppointmentsComputed }),
        React.createElement(dxReactCore.Getter, { name: "allDayElementsMeta", computed: getAllDayElementsMetaComputed }),
        React.createElement(dxReactCore.Getter, { name: "timeTableElementsMeta", computed: getTimeTableElementsMetaComputed }))); });
...
//# sourceMappingURL=dx-react-scheduler.umd.cjs.map
